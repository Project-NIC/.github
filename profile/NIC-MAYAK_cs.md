# NIC-Mayak — datová stanice (clock master + datalogger + uplink)
...
Mayak přidělí každému nodu TDMA slot, řekne *jeď*, a pak už jen **poslouchá, ukládá a
...
i starDust nody se věší na stejný master beze změny. Postav jeden dobrý Mayak a jeden

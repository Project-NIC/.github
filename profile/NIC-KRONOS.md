...
the clock fans out through the Bifrost bridges to every wire and fibre (the cable
itself carries **2²² Hz** — halved for cleaner transmission; each node regenerates
the 2²³ timebase inside), a PPS edge
